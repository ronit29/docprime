...
ES_PRIMARY_INDEX=env('ES_PRIMARY_INDEX')
ES_SECONDARY_INDEX_A=env('ES_SECONDARY_INDEX_A')
ES_SECONDARY_INDEX_B=env('ES_SECONDARY_INDEX_B')
ES_PRIMARY_INDEX_MAPPING_DATA=json.loads(env('ES_PRIMARY_INDEX_MAPPING_DATA'))
ES_SECONDARY_INDEX_MAPPING_DATA=json.loads(env('ES_SECONDARY_INDEX_MAPPING_DATA'))
