...
from .views import DoctorView, GenericSearchView, DoctorAvailability, DoctorProfile, DocotorAppointments, DoctorHospitalAvailability
...
urlpatterns = [
    ...
    url(r'^appointment', DocotorAppointments.as_view()),
