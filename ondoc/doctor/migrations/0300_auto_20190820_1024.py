# Generated by Django 2.0.5 on 2019-08-20 04:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('doctor', '0299_auto_20190820_0934'),
    ]

    operations = [
        migrations.CreateModel(
            name='HospitalNetworkTiming',
            fields=[
        ...
        migrations.AddField(
            model_name='hospitalnetworktiming',
            name='network',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='network_availability', to='doctor.HospitalNetwork'),
        ),
    ]
