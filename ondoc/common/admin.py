...
class CustomVersionAdmin(admin.ModelAdmin):
    ...
    def log_addition(self, request, object, change_message=None):
        ...
        try:
            super(CustomVersionAdmin, self).log_addition(request, object, change_message)
        except TypeError:  # Django < 1.9 pragma: no cover
            super(CustomVersionAdmin, self).log_addition(request, object)
    ...
    def __init__(self, *args, **kwargs):
        super(CustomVersionAdmin, self).__init__(*args, **kwargs)
    ...
    def get_urls(self):
        urls = super(CustomVersionAdmin, self).get_urls()
    ...
    def add_view(self, request, form_url='', extra_context=None):
        with self.create_revision(request):
            return super(CustomVersionAdmin, self).add_view(request, form_url, extra_context)

    def change_view(self, request, object_id, form_url='', extra_context=None):
        with self.create_revision(request):
            return super(CustomVersionAdmin, self).change_view(request, object_id, form_url, extra_context)
    ...
    def changelist_view(self, request, extra_context=None):
        with self.create_revision(request):
            ...
            context.update(extra_context or {})
            return super(CustomVersionAdmin, self).changelist_view(request, context)
    ...
    def history_view(self, request, object_id, extra_context=None):
        ...
        action_list = [
            {
                ...
                "changed_fields": version.field_dict if version.field_dict else None,
            }
            for version
        ...
        context.update(extra_context or {})
        return super(CustomVersionAdmin, self).history_view(request, object_id, context)

# Register your models here.
admin.site.register(PDFTester)