...
def send_lab_notifications_refactored(data, *args, **kwargs):
    ...
    else instance.address.get('phone_number'), 'test_list': test_list, 'client_code': '' if instance and instance.lab and instance.lab.network and instance.lab.network.id == 195 else 'CH343'}
