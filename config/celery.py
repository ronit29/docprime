...
def setup_periodic_tasks(sender, **kwargs):
    ...
    # update_merchant_payout_pg_status_cron_schedule = crontab(hour=10, minute=40)
    ...
    sender.add_periodic_task(crontab(hour=10, minute=15), doctors_daily_schedule.s(), name="Doctor's Daily Schedule")
