...
class CartViewSet(viewsets.GenericViewSet):
    ...
    def process(self, request, *args, **kwargs):
        ...
        if user.onhold_insurance:
            return Response(data={"error": "Your documents from the last claim are under verification. \
                            Please write to customercare@docprime.com for more information"}, status=status.HTTP_400_BAD_REQUEST)
