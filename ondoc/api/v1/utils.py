...
def payment_details(request, order):
    ...
    if order.product_id in [Order.SUBSCRIPTION_PLAN_PRODUCT_ID, Order.PROVIDER_ECONSULT_PRODUCT_ID]:
        isPreAuth = '0'
...
def get_pg_secret_client_key(order):
    ...
    if order.product_id in [Order.DOCTOR_PRODUCT_ID, Order.SUBSCRIPTION_PLAN_PRODUCT_ID, Order.PROVIDER_ECONSULT_PRODUCT_ID]:
