...
from ondoc.doctor.tasks import create_doctor_score, delete_search_score
...
def setup_periodic_tasks(sender, **kwargs):
    ...
    sender.add_periodic_task(doctor_search_score_creation_time, delete_search_score.s(), name='data deleted from Search Score model')
    sender.add_periodic_task(doctor_search_score_creation_time, DoctorSearchScore.calculate().s(), name='Data entered in Search Score model')
    sender.add_periodic_task(doctor_search_score_creation_time, create_doctor_score.s(), name='Doctor search score created')