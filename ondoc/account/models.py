...
class Order(TimeStampedModel):
    ...
    def get_cod_to_prepaid_appointment(self, update_order_and_appointment=False):
        ...
        if update_order_and_appointment:
            ...
            effective_price = 0
            coupon_discount, coupon_cashback, coupon_list, random_coupon_list = Coupon.get_total_deduction(self.action_data, self.action_data['prepaid_deal_price'])
            if coupon_discount >=  self.action_data['prepaid_deal_price']:
                effective_price = 0
            else:
                effective_price =  self.action_data['prepaid_deal_price'] - coupon_discount
            ...
            opd_obj.deal_price = self.action_data['prepaid_deal_price']
            opd_obj.save()
        return opd_obj
