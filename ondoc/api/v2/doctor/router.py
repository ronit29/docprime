...
urlpatterns = [
    ...
    path('ecs/create', views.PartnersAppInvoicePDF.as_view({'post': 'ecs_create'}), name='ecs_create'),
    path('ecs/list', views.PartnersAppInvoicePDF.as_view({'get': 'ecs_list'}), name='ecs_list'),
]
