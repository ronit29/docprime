        ...
        for resp in response:
            ...
            if doctor_entity:
                if doctor_entity.get('url'):
                    ...
                    url = None
                    if doctor_entity.get('url'):
                        url = doctor_entity.get('url') if doctor_entity.get('url').startswith('/') else '/' + doctor_entity.get('url')

                    resp['schema']['url'] = request.build_absolute_uri(url) if url else None
                    resp['new_schema']['url'] = request.build_absolute_uri(url) if url else None
