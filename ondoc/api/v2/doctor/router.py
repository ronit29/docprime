...
urlpatterns = [
    ...
    path('invoice/add/item', views.PartnersAppInvoice.as_view({'post': 'add_general_invoice_item'}), name='add-general-invoice-item'),
    ...
    path('invoice/<str:name>', views.PartnersAppInvoice.as_view({'get': 'download_pdf'}), name='invoice-pdf'),
