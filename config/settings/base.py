...
INSURANCE_CANCEL_INITIATE_EMAIL=env.list('INSURANCE_CANCEL_INITIATE_EMAIL')
INSURANCE_CANCELLATION_APPROVAL_ALERT_EMAIL=env.list('INSURANCE_CANCELLATION_APPROVAL_ALERT_EMAIL')
HOSPITALS_NOT_REQUIRED_UNIQUE_CODE=env('HOSPITALS_NOT_REQUIRED_UNIQUE_CODE')
MEDANTA_HOSPITAL_ID=env('MEDANTA_HOSPITAL_ID')