...
class NotificationAction:
    ...
    PROVIDER_OPD_APPOINTMENT_CONFIRMATION_ONLINE_PAYMENT = 321
    PROVIDER_OPD_APPOINTMENT_CONFIRMATION_PAY_AT_CLINIC = 322
    REMINDER_MESSAGE_MEDANTA_AND_ARTEMIS = 323
