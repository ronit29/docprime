                    ...
                    if pg_txn:
                        ...
                        if pg_txn.product_id == Order.CHAT_PRODUCT_ID:
                            ...
                            if chat_order:
                                ...
                                save_pg_response.apply_async((PgLogs.RESPONSE_TO_CHAT, chat_order.id, None, CHAT_REDIRECT_URL, None, None), eta=timezone.localtime(), queue=settings.RABBITMQ_LOGS_QUEUE)
