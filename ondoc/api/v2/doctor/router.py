...
urlpatterns = [
    ...
    path('partner-lab/tests', views.PartnerLabTestSamplesCollect.as_view({'get': 'tests_list'}), name='partner_lab_tests_list'),
    path('partner-lab/order/save', views.PartnerLabTestSamplesCollect.as_view({'post': 'order_create_or_update'}), name='partner_lab_order_create'),
    path('partner-lab/lab-alerts', views.PartnerLabTestSamplesCollect.as_view({'get': 'lab_alerts'}), name='test_samples_lab_alerts'),
]
